...
public: void addFrame(ofPixels& framePixels, unsigned long msPerFrame);
public: void addFrame(ofPixels& framePixels, float frameRate);

    public: void flushToFile();
    public: void addAudioTrack(const char* videoPath);
    ...
    private: void outputFrame(ofPixels& framePixels, float frameRate);

    
    public: void loadAudioTrack(const char* filename); 
