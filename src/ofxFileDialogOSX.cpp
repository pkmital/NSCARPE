...
//---------------------------------------------------------------------------------
int ofxFileDialogOSX::openFile(string& URL, string banner){
	...
	//options.modality = kWindowModalityAppModal;
	// adding a banner
	options.message = CFStringCreateWithCString(kCFAllocatorDefault, banner.c_str(), kCFStringEncodingMacRoman);
	NavDialogRef dialog;
