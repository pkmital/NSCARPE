...
class pkm3DMixtureOfGaussians
{
public:
    
    pkm3DMixtureOfGaussians()
    {
...
class pkm3DMixtureOfGaussiansHeatmap
{
public:
    ...
    pkm3DMixtureOfGaussiansHeatmap()
    {
        bAllocated = false;
        bNeedsUpdate = true;
        bNormalize = true;
    ...
    void setMixture(pkm3DMixtureOfGaussians mix)
    {
        mixture = mix;
...
private:
    ...
    pkm3DMixtureOfGaussians   mixture;
