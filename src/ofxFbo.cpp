...
void ofxFbo::setupScreenForWindow() {
	...
	float viewW = viewport[2];
	float viewH = viewport[3];
...
void ofxFbo::setup(int width, int height, int screenWidth, int screenHeight, bool useDepth, bool useStencil) {
	this->width = width;
	this->height = height;
    ...
    cout << "[ofxFBO]: Max color attachments: " << maxAttachments << endl;
